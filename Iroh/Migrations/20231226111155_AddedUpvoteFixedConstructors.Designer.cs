...
namespace Iroh.Migrations
{
    ...
    [Migration("20231226111155_AddedUpvoteFixedConstructors")]
    partial class AddedUpvoteFixedConstructors
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Iroh.Data.Thing", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            App = 1,
                            CreatedAt = new DateTime(2023, 12, 26, 12, 11, 54, 757, DateTimeKind.Local).AddTicks(4090),
